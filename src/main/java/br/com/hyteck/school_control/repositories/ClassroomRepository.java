...
public interface ClassroomRepository extends JpaRepository<ClassRoom, String> {
    Optional<ClassRoom> findByNameAndYear(String name, String schoolYear); // Ou (String, String)
    boolean existsByNameAndYear(String name, String schoolYear); // Ou (String, String);
}